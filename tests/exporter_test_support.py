...
def _payload(intake: dict, intake_path: Path, *, synthetic: bool = False) -> dict:
    ...
    return {
        ...
        "architecture_identity": {
            ...
            "review_unit_traces": [
                {
                    "architect_node_ref": "node-root",
                    "architect_evidence_refs": ["ev-stage7"],
                    "ce_review_unit_id": "ce-unit-root",
