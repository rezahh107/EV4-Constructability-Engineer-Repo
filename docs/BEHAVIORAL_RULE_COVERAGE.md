...
|---|---|---:|---|---|---|---|---|---|---|---|
| `R-CE-PAR-01` | Visual references must be lowered into a locked paradigm contract before Builder-ready output. | Critical | `protocols/REFERENCE_PARADIGM_LOCK.md` | `reference_paradigm_lock`, `paradigm_to_structure_map`, `builder_executable_package.reference_paradigm_lock`, `builder_executable_package.paradigm_to_structure_map` | `validator.reference_paradigm_lock`, `R29, R31, R32, R35, R36` | `tests/test_reference_carriers_contract.py::test_visual_parity_package_with_carried_reference_contract_passes` | `tests/test_reference_carriers_contract.py::test_visual_parity_package_requires_reference_carriers_inside_package` | `pytest -q`, `npm run test:reference-paradigm-lock` | Builder intake rejects missing or invalid reference carriers | `downstream_contract_enforced` |
| `R-CE-PAR-02` | Unknown visual paradigm must block Builder-ready visual-parity output. | Critical | `protocols/REFERENCE_PARADIGM_LOCK.md` | `layout_paradigm` | `R30_REFERENCE_PARADIGM_UNKNOWN_BLOCKS_BUILDER_READY` | `tests/valid/center_anchored_symmetric_pill_cards.json` | `tests/test_reference_carriers_contract.py::test_unknown_paradigm_carried_inside_package_still_blocks_visual_parity` | `pytest -q`, `npm run test:reference-paradigm-lock` | Builder intake rejects unknown visual paradigm | `downstream_contract_enforced` |
| `R-CE-GEO-01` | Geometry-dependent actions require a proof object, not only a boolean flag. | Critical | `README.md`, `docs/FAILURE_PATTERN_LIBRARY.md` | `geometry_required`, `geometry_proven`, `geometry_proof` | `R03`, `R24` | `tests/test_geometry_overlay_coverage_gates.py::test_geometry_proof_object_passes_gate` | `tests/test_geometry_overlay_coverage_gates.py::test_geometry_required_without_proof_fails`, `tests/test_geometry_overlay_coverage_gates.py::test_geometry_proven_requires_proof_object` | `pytest -q` | Builder must not infer geometry | `ci_enforced` |
| `R-CE-OVR-01` | Overlay and decorative layers require explicit containment, positioning, and z-index strategy. | Critical | `README.md`, `docs/FAILURE_PATTERN_LIBRARY.md` | `overlay_strategy_required`, `overlay_strategy_proven`, `overlay_strategy` | `R05`, `R25` | `tests/test_geometry_overlay_coverage_gates.py::test_overlay_strategy_object_passes_gate` | `tests/test_geometry_overlay_coverage_gates.py::test_overlay_required_without_strategy_fails`, `tests/test_geometry_overlay_coverage_gates.py::test_overlay_strategy_proven_requires_object` | `pytest -q` | Builder must not choose overlay containment | `ci_enforced` |
...
| `R-CE-DYN-01` | Dynamic Loop approval requires an explicit binding map. | High | `docs/FAILURE_PATTERN_LIBRARY.md` | `dynamic_loop_approved`, `dynamic_loop_binding_map` | `R08`, `R26` | `tests/test_dynamic_loop_coverage_gate.py::test_dynamic_loop_binding_map_passes_gate` | `tests/test_dynamic_loop_coverage_gate.py::test_dynamic_loop_implied_without_approval_fails`, `tests/test_dynamic_loop_coverage_gate.py::test_dynamic_loop_approval_requires_binding_map` | `pytest -q` | Builder must not infer Dynamic Loop | `ci_enforced` |
| `R-CE-UI-01` | Exact Elementor UI control paths require evidence object. | High | `docs/FAILURE_PATTERN_LIBRARY.md` | `ui_control_evidence_present`, `ui_control_evidence` | `R10`, `R27` | `tests/test_ui_evidence_coverage_gate.py::test_ui_control_evidence_object_passes_gate` | `tests/test_ui_evidence_coverage_gate.py::test_exact_ui_control_path_without_evidence_fails`, `tests/test_ui_evidence_coverage_gate.py::test_ui_control_evidence_present_requires_object` | `pytest -q` | Builder must not invent UI paths | `ci_enforced` |
| `R-CE-QA-01` | `production_ready: true` requires full QA evidence and QA matrix. | Critical | `docs/QUALITY_BAR.md` | `qa_status.full_qa_evidence_present`, `qa_matrix` | `R12`, `R28` | `tests/test_qa_coverage_gate.py::test_ready_claim_with_full_qa_matrix_passes_gate` | `tests/test_qa_coverage_gate.py::test_ready_claim_requires_full_qa_evidence`, `tests/test_qa_coverage_gate.py::test_ready_claim_requires_qa_matrix` | `pytest -q` | Downstream must keep `production_ready` false unless QA evidence is complete | `ci_enforced` |
